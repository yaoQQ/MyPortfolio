...
export const projects: Project[] = [
  {
    ...
    status: "上线阶段",
    description:
      "《我要当老祖》是一款修仙题材网游，核心玩法涵盖背包乱斗、多流派弟子收集培养与宠物养成系统。项目处于上线阶段，需要在较短时间内搭建高可扩展的核心玩法框架，同时保证复杂系统的稳定性与可维护性。\n\n采用Unity3D 高度优化的2D骨骼技术实现高性能实体管理，结合HybridCLR实现C#热更新，大幅提升开发迭代效率。设计并实现了背包乱斗、弟子收集培养、宠物养成等核心玩法系统，以及竞技场、弹幕、竞猜等社交竞技系统。\n\n在性能优化方面，针对场景和特效同屏渲染进行了深度优化，确保复杂场景下帧率稳定。通过资源管理系统实现了资源按需加载与内存优化，有效控制了包体大小与运行时内存占用。UGUI界面的深度定制、代码自动生成与优化保证了项目高效产出及多分辨率适配与流畅的交互体验。",
    techStack: ["Unity3D", "C#",  "HybridCLR", "UGUI", "C++"],
    highlights: [
      "代码自动化生成和高效产出",
  ...
  },
  {
    ...
    techStack: ["Flash/AS3", "Flash 3D", "自研引擎", "JavaScript"],
    highlights: [
      "暗黑西游风Shader与特效定制",
      "自研引擎核心模块开发",
      "Flash 3D渲染效率与表现力提升",
